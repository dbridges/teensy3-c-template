...
TOOLSPATH = $(HOME)/development/teensy/tools

# path location for Teensy 3 core
COREPATH = $(HOME)/development/teensy/cores/teensy3

# path location for custom libraries
LIBRARYPATH = $(HOME)/development/teensy/teensy3_db

# path location for the arm-none-eabi compiler
COMPILERPATH = $(HOME)/development/mac-arm-toolchain/bin
